  ...
  if (title && kicker) {
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          _index.Grid.Column,
          { width: 6, offset: offset, textAlign: 'left', className: blokContentDivideClass },
          _react2.default.createElement(_index.Text, { font: 'heading', type: 'title', size: 'h1', text: props.title, className: blokContentTitleClass }),
          _react2.default.createElement(_index.Text, { font: 'heading', type: 'sub', size: 'h3', tag: 'h2', text: props.kicker, className: blokContentKickerClass }),
          textData
        )
      )
    );
