...
var Panel = function Panel(props) {
  ...
  var blokHeaderClass = (0, _classnames2.default)((_cx = {}, _defineProperty(_cx, 'blok-header', true), _defineProperty(_cx, '' + className, className), _cx));
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        _index.Grid.Column,
        { width: 6, textAlign: 'right', className: blokHeaderClass },
        linkData
      )
    )
  );
