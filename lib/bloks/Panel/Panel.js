...
var Panel = function Panel(props) {
  ...
  var linkArr = link;
  var linkData = linkArr.map(function (rows) {
    var row = rows.map(function (cell) {
      return _react2.default.createElement(_index.Link, { text: cell.text, ref: cell.ref, active: cell.active });
    });
  });
  if (side === true) {
