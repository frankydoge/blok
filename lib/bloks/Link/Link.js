...
var Link = function Link(props) {
  ...
  var linkClass = (0, _classnames2.default)((_cx = {
    'link': true
  }, _defineProperty(_cx, 'color-background-' + color, color), _defineProperty(_cx, 'font-family-' + font, font), _defineProperty(_cx, 'font-size-' + size, size), _defineProperty(_cx, 'link-active', active), _defineProperty(_cx, '' + className, className), _cx));
